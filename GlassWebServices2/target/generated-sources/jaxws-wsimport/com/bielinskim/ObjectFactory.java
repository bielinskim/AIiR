 ...
 * generated in the com.bielinskim package. 
...
public class ObjectFactory {
    ...
    private final static QName _Mul_QNAME = new QName("http://bielinskim.com/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://bielinskim.com/", "mulResponse");
    private final static QName _AddResponse_QNAME = new QName("http://bielinskim.com/", "addResponse");
    private final static QName _Sub_QNAME = new QName("http://bielinskim.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://bielinskim.com/", "subResponse");
    private final static QName _Add_QNAME = new QName("http://bielinskim.com/", "add");
    private final static QName _Div_QNAME = new QName("http://bielinskim.com/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://bielinskim.com/", "divResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bielinskim
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bielinskim.com/", name = "divResponse")
