...
public class jProxy extends Thread
{
	...
	protected int thisPort = DEFAULT_PORT;
	protected String fwdServer = "";
	protected int fwdPort = 0;
	protected int ptTimeout = ProxyThread.DEFAULT_TIMEOUT;
...
class ProxyThread extends Thread
{
	...
	protected byte[] getHTTPData (InputStream in, boolean waitForDisconnect)
	{
	...
	/**
         ...
         * @return 
         */
	protected byte[] getHTTPData (InputStream in, StringBuffer host, boolean waitForDisconnect)
	{
		// 
	...
	protected int streamHTTPData (InputStream in, OutputStream out, boolean waitForDisconnect)
	{
		StringBuffer foo = new StringBuffer("");
		return streamHTTPData(in, out, foo, waitForDisconnect);
	}
	
	protected int streamHTTPData (InputStream in, OutputStream out, 
